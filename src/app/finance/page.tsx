...
export default function FinancePage() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="px-4 pb-4 space-y-6 bg-gray-50 flex-1">
        {yearTotals.map(({ year, total, finances }, index) => (
          <div key={year} className={`bg-white rounded-lg shadow-sm overflow-hidden ${index === 0 ? 'mt-4' : ''}`}>
            {/* Year Header */}
