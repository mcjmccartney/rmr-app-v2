...
CREATE TABLE IF NOT EXISTS sessions (
    ...
    session_type VARCHAR(50) NOT NULL CHECK (session_type IN ('In-Person', 'Online', 'Training - 1hr', 'Training - 30mins', 'Training - The Mount', 'Online Catchup', 'Group', 'Phone Call', 'Coaching')),
